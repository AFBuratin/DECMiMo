...
IPFData_models <- lapply(IPFDataFilt_list, function(count.matrix){
  # count.matrix = IPFDataFilt_list$ccp2
...
save(ALZData_models,file = "/blackhole/alessia/GLMM_article/data/ALZZinb_nb_Fit_detmet_models.RData")

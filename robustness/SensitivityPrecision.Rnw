...
png(paste0("/blackhole/alessia/GLMM_article/consinstency/DEcalls_evaluation_", Dataset,".png"), res = 150, units = "cm", width = 15, height = 15)
...
png(paste0("/blackhole/alessia/GLMM_article/consinstency/DEcalls_verification_", Dataset,".png"), res = 150, units = "cm", width = 15, height = 15)
p + geom_boxplot(outlier.colour=rgb(0,0,0,0)) + theme_bw() +
    geom_point(position = position_jitter(w = 0.1, h = 0), color="grey50", size=1) +
    # facet_grid(.~detection.method) +
    scale_color_manual(values = cols, guide="none") +
...
png(paste0("/blackhole/alessia/GLMM_article/robustness/Power_sensitivity_gold", Dataset,"_adj.png"), res = 150, units = "cm", width = 18, height = 18)
...
p + scale_color_manual(values = cols) + geom_boxplot(outlier.colour=rgb(0,0,0,0)) + theme_bw() + facet_wrap(~ verification) + 
  ...
  xlab("")
dev.off()
png(paste0("/blackhole/alessia/GLMM_article/robustness/Power_precision_gold", Dataset,"_adj.png"), res = 150, units = "cm", width = 18, height = 18)
...
png(paste0("/blackhole/alessia/GLMM_article/robustness/Power_sensitivity_", Dataset,"_adj.png"), res = 200, units = "cm", width = 20, height = 16)
p <- ggplot(d, aes(x=evaluation,y=sensitivity,color=evaluation))
p + geom_boxplot(outlier.colour=rgb(0,0,0,0)) + theme_bw() + 
